...
vim.api.nvim_set_hl(0, "xmlTag", { fg = dim_topaz_yellow })
vim.api.nvim_set_hl(0, "xmlTagName", { link = "xmlTag" })
vim.api.nvim_set_hl(0, "xmlAttrib", { fg = soft_grey })
vim.api.nvim_set_hl(0, "xmlProcessingDelim", { link = "xmlTag" })