...
vim.api.nvim_set_hl(0, "Statement", { link = "@property" })
vim.api.nvim_set_hl(0, "Constant", { link = "@constant.builtin" })
vim.api.nvim_set_hl(0, "jsonNull", { link = "@constant.builtin" })
vim.api.nvim_set_hl(0, "String", { link = "@string" })
vim.api.nvim_set_hl(0, "Delimiter", { link = "@punctuation.bracket" })
vim.api.nvim_set_hl(0, "Quote", { link = "@comment" })
vim.api.nvim_set_hl(0, "Noise", { fg = dim_blue })
vim.api.nvim_set_hl(0, "Special", { link = "@constructor" })